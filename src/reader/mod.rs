...
use crate::{Index, Inventory, Searcher, TantivySegmentReader, TrackedObject};
...
impl InnerIndexReader {
    ...
    fn open_segment_readers(index: &Index) -> crate::Result<Vec<TantivySegmentReader>> {
